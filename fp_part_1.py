...
console_query = (result_df
    .withColumnRenamed("bio_country_noc", "country_noc")  # Ensure correct column name
    .writeStream
    .outputMode("complete")  # Use "complete" since we're doing aggregations
    .format("console")  # Console sink to print data
